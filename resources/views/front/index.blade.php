            ...
            <div id="rev_slider_ishop" class="rev_slider fullwidthbanner" style="display:none;" data-version="5.1.4">
                <ul>    <!-- SLIDE  -->
                    <li data-transition="fade" data-slotamount="1" data-masterspeed="1500" data-delay="5000" data-saveperformance="off" data-title="Latest Collections" style="background-color: #F6F6F6;">
                        ...
                        data-endspeed="1000"
                        data-endeasing="Power4.easeIn"><img src="{{ asset('assets/front/images/slider/rev/shop/girl1.jpg') }}" alt="Girl"></div>
                    ...
                    <li data-transition="slideup" data-slotamount="1" data-masterspeed="1500" data-delay="5000"  data-saveperformance="off"  data-title="Messenger bags" style="background-color: #E9E8E3;">
                        ...
                        data-endelementdelay="0.1"
                        data-endspeed="1000"
                        data-endeasing="Power4.easeIn"><img src="{{ asset('assets/front/images/slider/rev/shop/bag.png') }}" alt="Bag"></div>
                        ...
                        data-endelementdelay="0.1"
                        data-endspeed="1000"
                        data-endeasing="Power4.easeIn"><img src="{{ asset('assets/front/images/slider/rev/shop/tag.png') }}" alt="Bag"></div>
            ...
            <div class="container clearfix">
                ...
                <div class="row align-items-stretch gutter-20 min-vh-60">
                    <div class="col-md-8">
                        ...
                        <div class="row align-items-stretch gutter-20 h-100">
                            <div class="col-md-6 min-vh-25 min-vh-md-0">
                                <a href="#" class="grid-inner d-block h-100" style="background-image: url('{{ asset('assets/front/images/shop/banners/2.jpg') }}');"></a>
                            </div>

                            <div class="col-md-6 min-vh-25 min-vh-md-0">
                                <a href="#" class="grid-inner d-block h-100" style="background-image: url('{{ asset('assets/front/images/shop/banners/8.jpg') }}'); background-position: right center;"></a>
                            </div>

                            <div class="col-md-12 min-vh-25 min-vh-md-0 pb-md-0">
                                <a href="#" class="grid-inner d-block h-100" style="background-image: url('{{ asset('assets/front/images/shop/banners/4.jpg') }}');"></a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 min-vh-50">
                        <a href="#" class="grid-inner d-block h-100" style="background-image: url('{{ asset('assets/front/images/shop/banners/9.jpg') }}'); background-position: center top;"></a>
                    </div>
                </div>
                        ...
                        <div class="tab-content" id="tabs-9">
                            ...
                            <div class="shop row gutter-30">
                                ...
                                <div class="product col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="grid-inner">
                                        <div class="product-image">
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/dress/1.jpg') }}" alt="Checked Short Dress"></a>
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/dress/1-1.jpg') }}" alt="Checked Short Dress"></a>
                                ...
                                <div class="product col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="grid-inner">
                                        <div class="product-image">
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/pants/1-1.jpg') }}" alt="Slim Fit Chinos"></a>
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/pants/1.jpg') }}" alt="Slim Fit Chinos"></a>
                                            <div class="bg-overlay">
                                                <div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
                                                    <a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
                                                    <a href="include/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
                                            ...
                                            <div class="fslider" data-arrows="false">
                                                <div class="flexslider">
                                                    <div class="slider-wrap">
                                                        <div class="slide"><a href="#"><img src="{{ asset('assets/front/images/shop/shoes/1.jpg') }}" alt="Dark Brown Boots"></a></div>
                                                        <div class="slide"><a href="#"><img src="{{ asset('assets/front/images/shop/shoes/1-1.jpg') }}" alt="Dark Brown Boots"></a></div>
                                                        <div class="slide"><a href="#"><img src="{{ asset('assets/front/images/shop/shoes/1-2.jpg') }}" alt="Dark Brown Boots"></a></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="bg-overlay">
                                ...
                                <div class="product col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="grid-inner">
                                        <div class="product-image">
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/dress/2.jpg') }}" alt="Light Blue Denim Dress"></a>
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/dress/2-2.jpg') }}" alt="Light Blue Denim Dress"></a>
                                            <div class="bg-overlay">
                                                <div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
                                                    <a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
                                                    <a href="include/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
                        ...
                        <div class="tab-content" id="tabs-10">
                            ...
                            <div class="shop row gutter-30">
                                ...
                                <div class="product col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="grid-inner">
                                        <div class="product-image">
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/sunglasses/1.jpg') }}" alt="Unisex Sunglasses"></a>
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/sunglasses/1-1.jpg') }}" alt="Unisex Sunglasses"></a>
                                ...
                                <div class="product col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="grid-inner">
                                        <div class="product-image">
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/tshirts/1.jpg') }}" alt="Blue Round-Neck Tshirt"></a>
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/tshirts/1-1.jpg') }}" alt="Blue Round-Neck Tshirt"></a>
                                            <div class="bg-overlay">
                                                <div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
                                                    <a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
                                                    <a href="include/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
                                ...
                                <div class="product col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="grid-inner">
                                        <div class="product-image">
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/watches/1.jpg') }}" alt="Silver Chrome Watch"></a>
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/watches/1-1.jpg') }}" alt="Silver Chrome Watch"></a>
                                            <div class="bg-overlay">
                                                <div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
                                                    <a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
                                                    <a href="include/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
                                ...
                                <div class="product col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="grid-inner">
                                        <div class="product-image">
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/shoes/2.jpg') }}" alt="Men Grey Casual Shoes"></a>
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/shoes/2-1.jpg') }}" alt="Men Grey Casual Shoes"></a>
                                            <div class="sale-flash badge bg-danger p-2">Sale!</div>
                                            <div class="bg-overlay">
                                                <div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
                                                    <a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
                        ...
                        <div class="tab-content" id="tabs-11">
                            ...
                            <div class="shop row gutter-30">
                                    ...
                                    <div class="grid-inner">
                                        <div class="product-image">
                                            <div class="fslider" data-arrows="false">
                                                <div class="flexslider">
                                                    <div class="slider-wrap">
                                                        <div class="slide"><a href="#"><img src="{{ asset('assets/front/images/shop/dress/3.jpg') }}" alt="Pink Printed Dress"></a></div>
                                                        <div class="slide"><a href="#"><img src="{{ asset('assets/front/images/shop/dress/3-1.jpg') }}" alt="Pink Printed Dress"></a></div>
                                                        <div class="slide"><a href="#"><img src="{{ asset('assets/front/images/shop/dress/3-2.jpg') }}" alt="Pink Printed Dress"></a></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="bg-overlay">
                                ...
                                <div class="product col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="grid-inner">
                                        <div class="product-image">
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/pants/5.jpg') }}" alt="Green Trousers"></a>
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/pants/5-1.jpg') }}" alt="Green Trousers"></a>
                                            <div class="sale-flash badge bg-danger p-2">Sale!</div>
                                            <div class="bg-overlay">
                                                <div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
                                                    <a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
                                ...
                                <div class="product col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="grid-inner">
                                        <div class="product-image">
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/sunglasses/2.jpg') }}" alt="Men Aviator Sunglasses"></a>
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/sunglasses/2-1.jpg') }}" alt="Men Aviator Sunglasses"></a>
                                            <div class="bg-overlay">
                                                <div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
                                                    <a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
                                                    <a href="include/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
                                ...
                                <div class="product col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="grid-inner">
                                        <div class="product-image">
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/tshirts/4.jpg') }}" alt="Black Polo Tshirt"></a>
                                            <a href="#"><img src="{{ asset('assets/front/images/shop/tshirts/4-1.jpg') }}" alt="Black Polo Tshirt"></a>
                                            <div class="bg-overlay">
                                                <div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
                                                    <a href="#" class="btn btn-dark me-2"><i class="icon-shopping-basket"></i></a>
                                                    <a href="include/ajax/shop-item.html" class="btn btn-dark" data-lightbox="ajax"><i class="icon-line-expand"></i></a>
                ...
                <ul class="clients-grid grid-2 grid-sm-3 grid-md-6 mb-0">
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/1.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/2.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/3.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/4.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/5.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/6.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/7.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/8.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/9.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/10.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/11.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/12.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/13.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/14.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/15.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/16.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/19.png') }}" alt="Clients"></a></li>
                    <li class="grid-item"><a href="#"><img src="{{ asset('assets/front/images/clients/logo/18.png') }}" alt="Clients"></a></li>
                </ul>
                ...
                <div class="container clearfix">
                    ...
                    <div class="row col-mb-50">
                        <div class="col-md-6 d-none d-md-flex align-self-end">
                            <img src="{{ asset('assets/front/images/services/4.jpg') }}" alt="Image" class="mb-0">
                        </div>
