                            ...
                            <div class="top-links on-click">
                                <ul class="top-links-container">
                                    ...
                                    <li class="top-links-item"><a href="#">EN</a>
                                        <ul class="top-links-sub-menu">
                                            <li class="top-links-item"><a href="#"><img src="{{ asset('assets/front/images/icons/flags/french.png') }}" alt="French"> FR</a></li>
                                            <li class="top-links-item"><a href="#"><img src="{{ asset('assets/front/images/icons/flags/italian.png') }}" alt="Italian"> IT</a></li>
                                        ...
                                        <div class="top-cart-items">
                                            <div class="top-cart-item">
                                                <div class="top-cart-item-image">
                                                    <a href="#"><img src="{{ asset('assets/front/images/shop/small/1.jpg') }}" alt="Blue Round-Neck Tshirt" /></a>
                                                </div>
                                            ...
                                            <div class="top-cart-item">
                                                <div class="top-cart-item-image">
                                                    <a href="#"><img src="{{ asset('assets/front/images/shop/small/6.jpg') }}" alt="Light Blue Denim Dress" /></a>
                                                </div>
                                                <div class="top-cart-item-desc">
                                                    <div class="top-cart-item-desc-title">
                                ...
                                <div class="row col-mb-50">
                                    <div class="col-md-4">
                                        ...
                                        <div class="widget clearfix">
                                            ...
                                            <img src="{{ asset('assets/front/images/footer-widget-logo.png') }}" alt="Image" class="footer-logo">

                                            <p>We believe in <strong>Simple</strong>, <strong>Creative</strong> &amp; <strong>Flexible</strong> Design Standards.</p>

                                            <div style="background: url('{{ asset('assets/front/images/world-map.png') }}') no-repeat center center; background-size: 100%;">
                                                <address>
