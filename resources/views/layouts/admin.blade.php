...
<html class="loading" lang="en" data-textdirection="rtl">
    ...
    <!-- fixed-top-->
        ...
        <footer class="footer footer-static footer-light navbar-border navbar-shadow">
            ...
            <span class="float-md-left d-block d-md-inline-block">Copyright &copy;  <a class="text-bold-800 grey darken-2" href="" target="_blank">Ahmed Emam </a>, All rights reserved. </span>
