                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" method="POST" action="{{ route('admin.languages.store') }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ old('abbr') }}" id="name"
        ...
        $(document).on('click', '#submit', function(e){
            ...
            $.ajax({
                ...
                success : function(data){
                    if(data.status == true)
                        $('#alert-success').show();
                        $('#alert-success').text('{{ __('Language added successfully.') }}');
                },
