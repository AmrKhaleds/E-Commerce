                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{ route('admin.languages.update', $getLanguage->id) }}" method="POST" enctype="multipart/form-data">
                                            @method('PUT')
                                            @csrf
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="name"
                                                                ...
                                                                name="name" value="{{ $getLanguage->name; }}">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $getLanguage->abbr; }}" id="name"
                                                                class="form-control" placeholder="ادخل اختصار اللغة  "
                                                                name="abbr">
                                                                <span id="abbr_error" class="text-danger"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="direction" class="select2 form-control">
                                                                <optgroup label="">
                                                                    <option disabled selected>من فضلك أختر اتجاه اللغة </option>
                                                                    <option value="rtl" @if($getLanguage->direction == 'rtl') selected @endif>من اليمين الي اليسار</option>
                                                                    <option value="ltr" @if($getLanguage->direction == 'ltr') selected @endif>من اليسار الي اليمين</option>
                                                                </optgroup>
                                                            </select>
                                                                <span id="direction_error" class="text-danger"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1" name="active" id="switcheryColor4"
                                                                class="switchery" data-color="success" @if($getLanguage -> active == 1) checked @endif />
